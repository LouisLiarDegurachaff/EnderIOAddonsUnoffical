...
import static loenwind.enderioaddons.config.Config.seedsRFperGrowthTick;
...
import loenwind.enderioaddons.common.WorldHelper;
...
public class EioaGrowthRequirement implements IGrowthRequirement {
    ...
    public EioaGrowthRequirement() {
        ...
        List<ItemStack> list = loenwind.enderioaddons.config.ItemHelper.readList(Config.plantRequiredBlocks);
        if (list != null) {
            if (list.size() == 3) {
