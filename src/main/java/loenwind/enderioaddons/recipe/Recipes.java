package loenwind.enderioaddons.recipe;

import static crazypants.util.RecipeUtil.addShaped;
import static crazypants.util.RecipeUtil.addShapeless;
import static loenwind.enderioaddons.config.Config.farmSeedlessRecipesEnabled;
import static loenwind.enderioaddons.machine.cobbleworks.BlockCobbleworks.blockCobbleworks;
import static loenwind.enderioaddons.machine.drain.BlockDrain.blockDrain;
import static loenwind.enderioaddons.machine.ihopper.BlockIHopper.blockIHopper;
import static loenwind.enderioaddons.machine.magcharger.BlockMagCharger.blockMagCharger;
import static loenwind.enderioaddons.machine.niard.BlockNiard.blockNiard;
import static loenwind.enderioaddons.machine.pmon.BlockPMon.blockPMon;
import static loenwind.enderioaddons.machine.tcom.BlockTcom.blockTcom;
import static loenwind.enderioaddons.machine.voidtank.BlockVoidTank.blockVoidTank;
import static loenwind.enderioaddons.machine.waterworks.BlockWaterworks.blockWaterworks;
...
import loenwind.enderioaddons.machine.afarm.item.Module;
