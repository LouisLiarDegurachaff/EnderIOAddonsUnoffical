...
import loenwind.autosave.engine.StorableEngine;
import loenwind.autosave.exceptions.NoHandlerFoundException;
import loenwind.enderioaddons.common.NullHelper;
...
public class HandleStorable<T extends Object> implements IHandler<T> {
    ...
    public boolean canHandle(Class<?> clazz) {
        Storable annotation = clazz.getAnnotation(loenwind.autosave.annotations.Storable.class);
